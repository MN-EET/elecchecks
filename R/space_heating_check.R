...
#' }
space_heating_check <- function(file_check, dest_dir){

  markdown_path <- system.file("rmarkdown/templates/space_heating_template/skeleton", "skeleton.Rmd", package = "elecchecks")
  ...
  rmarkdown::render(markdown_path,
                    ...
                    output_file = "REIS Electricity Space Heating Check.html",
                    output_dir = dest_dir)
}
